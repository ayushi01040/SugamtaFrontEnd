...
export default function ManageClientsPage() { 
  ...
  useEffect(() => {
    ...
    (async () => {
      ...
      try {
        ...
        console.error("Error fetching clients in ManageClientsPage:", error);
  ...
  return (
    <div className="space-y-4 p-6">
        ...
        <table className="min-w-full divide-y divide-gray-200">
          ...
          <tbody>
            {loading ? (
              ...
              filtered.map((r) => (
                <tr key={r.ClientId} className="border-t hover:bg-gray-50 transition-colors">
      ...
      >
        {loadingAgencies ? (
          <div className="p-4 text-center text-gray-600">Loading agencies…</div>
        ) : agencies.length > 0 ? (
            ...
            {agencies.map((agency, i) => (
              <div key={i} className="border rounded-lg p-3 bg-slate-50">
                {Object.entries(agency).map(([key, val]) => (
                  <div key={key} className="flex border-b last:border-b-0 py-1">
